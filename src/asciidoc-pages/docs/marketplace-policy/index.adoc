...
https://github.com/adoptium/adoptium/issues/new?labels=marketplace%2Cpublisher&template=marketplace_list_new_publisher.yml&title=%5BMarketplace%5D%3A+[open a request with the Adoptium Working Group^]
